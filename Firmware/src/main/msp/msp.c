...
static bool mspProcessOutCommand(int16_t cmdMSP, sbuf_t *dst)
{
    ...
    case MSP_RC_TUNING:
        ...
        sbufWriteU16(dst, currentControlRateProfile->tpaFactor_P_40);
        sbufWriteU16(dst, currentControlRateProfile->tpaFactor_P_50);
        sbufWriteU16(dst, currentControlRateProfile->tpaFactor_P_60);
        sbufWriteU16(dst, currentControlRateProfile->tpaFactor_P_70);
        sbufWriteU16(dst, currentControlRateProfile->tpaFactor_P_80);
        sbufWriteU16(dst, currentControlRateProfile->tpaFactor_P_90);
        sbufWriteU16(dst, currentControlRateProfile->tpaFactor_P_100);
        sbufWriteU16(dst, currentControlRateProfile->tpaFactor_I_10);
        sbufWriteU16(dst, currentControlRateProfile->tpaFactor_I_20);
        sbufWriteU16(dst, currentControlRateProfile->tpaFactor_I_30);
        sbufWriteU16(dst, currentControlRateProfile->tpaFactor_I_40);
        sbufWriteU16(dst, currentControlRateProfile->tpaFactor_I_50);
        sbufWriteU16(dst, currentControlRateProfile->tpaFactor_I_60);
        sbufWriteU16(dst, currentControlRateProfile->tpaFactor_I_70);
        sbufWriteU16(dst, currentControlRateProfile->tpaFactor_I_80);
        sbufWriteU16(dst, currentControlRateProfile->tpaFactor_I_90);
        sbufWriteU16(dst, currentControlRateProfile->tpaFactor_I_100);
        sbufWriteU16(dst, currentControlRateProfile->tpaFactor_D_10);
        sbufWriteU16(dst, currentControlRateProfile->tpaFactor_D_20);
        sbufWriteU16(dst, currentControlRateProfile->tpaFactor_D_30);
        sbufWriteU16(dst, currentControlRateProfile->tpaFactor_D_40);
        sbufWriteU16(dst, currentControlRateProfile->tpaFactor_D_50);
        sbufWriteU16(dst, currentControlRateProfile->tpaFactor_D_60);
