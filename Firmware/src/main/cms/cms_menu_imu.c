...
static const OSD_Entry cmsx_menuPidEntries[] =
{
    ...
    { "ROLL  P", OME_UINT16, NULL, &(OSD_UINT16_t){ &tempPid[PID_ROLL][0],  0, 200, 1 }, 0 },
    { "ROLL  I", OME_UINT16, NULL, &(OSD_UINT16_t){ &tempPid[PID_ROLL][1],  0, 200, 1 }, 0 },
    ...
    { "PITCH P", OME_UINT16, NULL, &(OSD_UINT16_t){ &tempPid[PID_PITCH][0], 0, 200, 1 }, 0 },
    { "PITCH I", OME_UINT16, NULL, &(OSD_UINT16_t){ &tempPid[PID_PITCH][1], 0, 200, 1 }, 0 },
    ...
    { "YAW   P", OME_UINT16, NULL, &(OSD_UINT16_t){ &tempPid[PID_YAW][0],   0, 200, 1 }, 0 },
    { "YAW   I", OME_UINT16, NULL, &(OSD_UINT16_t){ &tempPid[PID_YAW][1],   0, 200, 1 }, 0 },
...
static const OSD_Entry cmsx_menuPidTPAEntries[] =
{
    ...
    {"TPA P",   OME_Submenu, cmsMenuChange,                 &cmsx_menuTPAP,                                                 0},
    {"TPA I",   OME_Submenu, cmsMenuChange,                 &cmsx_menuTPAI,                                                 0},
    {"TPA D",   OME_Submenu, cmsMenuChange,                 &cmsx_menuTPAD,                                                 0},
