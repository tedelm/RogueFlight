...
void FAST_CODE pidController(const pidProfile_t *pidProfile, timeUs_t currentTimeUs)
{
    ...
    const float tpaFactor_P = getThrottlePIDAttenuationP();
    const float tpaFactor_I = getThrottlePIDAttenuationI();
    const float tpaFactor_D = getThrottlePIDAttenuationD();    
