...
// PG_CONTROLRATE_PROFILES
    ...
    { "tpaFactor_P_10",             VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_P_10) },
    { "tpaFactor_P_20",             VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_P_20) },
    { "tpaFactor_P_30",             VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_P_30) },
    { "tpaFactor_P_40",             VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_P_40) },
    { "tpaFactor_P_50",             VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_P_50) },
    { "tpaFactor_P_60",             VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_P_60) },
    { "tpaFactor_P_70",             VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_P_70) },
    { "tpaFactor_P_80",             VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_P_80) },
    { "tpaFactor_P_90",             VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_P_90) },
    { "tpaFactor_P_100",            VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_P_100) },	
    { "tpaFactor_I_10",             VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_I_10) },
    { "tpaFactor_I_20",             VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_I_20) },
    { "tpaFactor_I_30",             VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_I_30) },
    { "tpaFactor_I_40",             VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_I_40) },
    { "tpaFactor_I_50",             VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_I_50) },
    { "tpaFactor_I_60",             VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_I_60) },
    { "tpaFactor_I_70",             VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_I_70) },
    { "tpaFactor_I_80",             VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_I_80) },
    { "tpaFactor_I_90",             VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_I_90) },
    { "tpaFactor_I_100",            VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_I_100) },	
    { "tpaFactor_D_10",             VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_D_10) },
    { "tpaFactor_D_20",             VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_D_20) },
    { "tpaFactor_D_30",             VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_D_30) },
    { "tpaFactor_D_40",             VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_D_40) },
    { "tpaFactor_D_50",             VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_D_50) },
    { "tpaFactor_D_60",             VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_D_60) },
    { "tpaFactor_D_70",             VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 1000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, tpaFactor_D_70) },
...
#ifdef USE_WATT_MODE
    { "watt_mode_watt",            VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 10, 10000}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, watt_mode_watt) },
    { "watt_mode_maxAmp",            VAR_UINT16  | PROFILE_RATE_VALUE, .config.minmax = { 1, 500}, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, watt_mode_maxAmp) },
...
// PG_PID_PROFILE
#ifdef USE_PROFILE_NAMES
    { "profile_name",               VAR_UINT16  | PROFILE_VALUE | MODE_STRING, .config.string = { 1, MAX_PROFILE_NAME_LENGTH, STRING_FLAGS_NONE }, PG_PID_PROFILE, offsetof(pidProfile_t, profileName) },
#endif
#ifdef USE_DYN_LPF
    ...
    { "p_pitch",                    VAR_UINT16  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 200 }, PG_PID_PROFILE, offsetof(pidProfile_t, pid[PID_PITCH].P) },
    { "i_pitch",                    VAR_UINT16  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 200 }, PG_PID_PROFILE, offsetof(pidProfile_t, pid[PID_PITCH].I) },
    { "d_pitch",                    VAR_UINT16  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 800 }, PG_PID_PROFILE, offsetof(pidProfile_t, pid[PID_PITCH].D) },
    { "f_pitch",                    VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 2000 },PG_PID_PROFILE, offsetof(pidProfile_t, pid[PID_PITCH].F) },
    { "p_roll",                     VAR_UINT16  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 200 }, PG_PID_PROFILE, offsetof(pidProfile_t, pid[PID_ROLL].P) },
    { "i_roll",                     VAR_UINT16  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 200 }, PG_PID_PROFILE, offsetof(pidProfile_t, pid[PID_ROLL].I) },
    { "d_roll",                     VAR_UINT16  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 800 }, PG_PID_PROFILE, offsetof(pidProfile_t, pid[PID_ROLL].D) },
    { "f_roll",                     VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 2000 },PG_PID_PROFILE, offsetof(pidProfile_t, pid[PID_ROLL].F) },
    { "p_yaw",                      VAR_UINT16  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 200 }, PG_PID_PROFILE, offsetof(pidProfile_t, pid[PID_YAW].P) },
    { "i_yaw",                      VAR_UINT16  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 200 }, PG_PID_PROFILE, offsetof(pidProfile_t, pid[PID_YAW].I) },
    { "d_yaw",                      VAR_UINT16  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 800 }, PG_PID_PROFILE, offsetof(pidProfile_t, pid[PID_YAW].D) },
    { "f_yaw",                      VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 2000 },PG_PID_PROFILE, offsetof(pidProfile_t, pid[PID_YAW].F) },

    { "angle_level_strength",       VAR_UINT16  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 200 }, PG_PID_PROFILE, offsetof(pidProfile_t, pid[PID_LEVEL].P) },
    { "horizon_level_strength",     VAR_UINT16  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 200 }, PG_PID_PROFILE, offsetof(pidProfile_t, pid[PID_LEVEL].I) },
    { "horizon_transition",         VAR_UINT16  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 800 }, PG_PID_PROFILE, offsetof(pidProfile_t, pid[PID_LEVEL].D) },
...
#ifdef USE_D_MIN
    { "d_min_roll",                 VAR_UINT16 | PROFILE_VALUE,  .config.minmaxUnsigned = { 0, 800 }, PG_PID_PROFILE, offsetof(pidProfile_t, d_min[FD_ROLL]) },
    { "d_min_pitch",                VAR_UINT16 | PROFILE_VALUE,  .config.minmaxUnsigned = { 0, 800 }, PG_PID_PROFILE, offsetof(pidProfile_t, d_min[FD_PITCH]) },
    { "d_min_yaw",                  VAR_UINT16 | PROFILE_VALUE,  .config.minmaxUnsigned = { 0, 800 }, PG_PID_PROFILE, offsetof(pidProfile_t, d_min[FD_YAW]) },
    { "d_min_boost_gain",           VAR_UINT16 | PROFILE_VALUE,  .config.minmaxUnsigned = { 0, 800 }, PG_PID_PROFILE, offsetof(pidProfile_t, d_min_gain) },
    { "d_min_advance",              VAR_UINT16 | PROFILE_VALUE,  .config.minmaxUnsigned = { 0, 800 }, PG_PID_PROFILE, offsetof(pidProfile_t, d_min_advance) },
#endif
