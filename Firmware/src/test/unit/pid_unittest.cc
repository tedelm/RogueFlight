...
extern "C" {
    ...
    float getThrottlePIDAttenuationP(void) { return simulatedThrottlePIDAttenuation; }
    float getThrottlePIDAttenuationI(void) { return simulatedThrottlePIDAttenuation; }
    float getThrottlePIDAttenuationD(void) { return simulatedThrottlePIDAttenuation; }
...
void setDefaultTestSettings(void) {
    ...
    pidProfile->pid[PID_ROLL]  =  { 45, 45, 300, 65 };
    pidProfile->pid[PID_PITCH] =  { 45, 45, 350, 60 };
    pidProfile->pid[PID_YAW]   =  { 90, 55, 0, 60 };
    pidProfile->pid[PID_LEVEL] =  { 50, 50, 750, 0 };
